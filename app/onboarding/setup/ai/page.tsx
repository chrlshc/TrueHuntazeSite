...
export default function AIPage({ searchParams }: { searchParams?: Record<string, string | string[] | undefined> }) {
  ...
  return (
    <OnboardingSetupClient initialOnlyfansConnected={initialOnlyfansConnected} forceStep="ai-config" navMode="route" locale={locale} />
  )
}
