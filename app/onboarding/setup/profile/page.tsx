...
export default function ProfileStepPage({ searchParams }: { searchParams?: Record<string, string | string[] | undefined> }) {
  ...
  return (
    <OnboardingSetupClient initialOnlyfansConnected={initialOnlyfansConnected} showConnectedToast={showConnectedToast} forceStep="profile" navMode="route" locale={locale} />
  )
}
