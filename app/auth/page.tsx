          ...
          {!showEmailForm ? (
            <>
              ...
              <div className="space-y-3">
                ...
                <button
                  disabled
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg opacity-50 cursor-not-allowed"
                >
