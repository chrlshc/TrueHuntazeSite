...
const azure_openai_service_1 = require("../../services/azure-openai.service");
...
exports.AzureOpenAIModule = AzureOpenAIModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [azure_openai_service_1.AzureOpenAIService],
        exports: [azure_openai_service_1.AzureOpenAIService],
    })
], AzureOpenAIModule);
