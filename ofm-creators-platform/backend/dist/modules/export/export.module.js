...
const cross_channel_analytics_module_1 = require("../analytics/cross-channel/cross-channel-analytics.module");
let ExportModule = class ExportModule {
};
exports.ExportModule = ExportModule;
exports.ExportModule = ExportModule = __decorate([
    (0, common_1.Module)({
        imports: [cross_channel_analytics_module_1.CrossChannelAnalyticsModule],
